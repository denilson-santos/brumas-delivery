<div class="restaurant-container col-md-12">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="restaurant-image">
                            <img src="https://image.shutterstock.com/image-vector/pizza-hand-written-lettering-logo-260nw-542294653.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-md-10">
                        <div class="restaurant-content">
                            <div class="row">
                                <div class="col-md-6">
                                    <h1 class="restaurant-name">Pizzaria Hut</h1>
                                    <span class="restaurant-categories">Pizzas</span>
    ...
    <div class="tab-content restaurant-body">
        <div class="tab-pane container active" id="restaurant-menu">
            <div class="restaurant-category"><span>Pizzas</span></div>
            <div class="row c-px-1 my-2">
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            <div class="col-md-3 plate-image">
                                <img src="<?php echo BASE_URL.'media/categories/pizzas/pizza-img-default-150x150.jpg' ?>" alt="">
                            </div>
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Pequena</div>    
                                <div class="plate-description"></div>
                                <div class="plate-prices">
                                    <span class="price-old mr-3">R$ 34,00</span>
                                    <span class="price-promo">R$ 30,50</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Média</div>    
                                <div class="plate-description"></div>
                                <div class="plate-prices">
                                    <span class="price-old mr-3">R$ 38,00</span>
                                    <span class="price-promo">R$ 34,50</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Grande</div>    
                                <div class="plate-description"></div>
                                <div class="plate-prices">
                                    <span class="price-old mr-3">R$ 45,00</span>
                                    <span class="price-promo">R$ 40,50</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Extra Grande</div>    
                                <div class="plate-description"></div>
                                <div class="plate-prices">
                                    <span class="price-old mr-3">R$ 64,00</span>
                                    <span class="price-promo">R$ 60,50</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="restaurant-category"><span>Bebidas</span></div>
            <div class="row c-px-1 my-2">
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            <div class="col-md-3 plate-image">
                                <img src="<?php echo BASE_URL.'media/categories/drinks/drink-img-default-150x150.jpg' ?>" alt="">
                            </div>
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Pequena</div>    
                                <div class="plate-description"></div>
            ...
            <div class="restaurant-category"><span>Sorvetes</span></div>
            <div class="row c-px-1 my-2">
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            <div class="col-md-3 plate-image">
                                <img src="<?php echo BASE_URL.'media/categories/ice-creams/ice-cream-img-default.jpg' ?>" alt="">
                            </div>
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Pequena</div>    
                                <div class="plate-description"></div>
            ...
            <div class="restaurant-category"><span>Lanches</span></div>
            <div class="row c-px-1 my-2">
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            <div class="col-md-3 plate-image">
                                <img src="<?php echo BASE_URL.'media/categories/snacks/snack-img-default-150x150.jpg' ?>" alt="">
                            </div>
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Pequena</div>    
                                <div class="plate-description"></div>
            ...
            <div class="restaurant-category"><span>Bolos</span></div>
            <div class="row c-px-1 my-2">
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            <div class="col-md-3 plate-image">
                                <img src="<?php echo BASE_URL.'media/categories/cakes/cake-img-default-150x150.jpg' ?>" alt="">
                            </div>
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Pequena</div>    
                                <div class="plate-description"></div>
            ...
            <div class="restaurant-category"><span>Sobremesas</span></div>
            <div class="row c-px-1 my-2">
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            <div class="col-md-3 plate-image">
                                <img src="<?php echo BASE_URL.'media/categories/desserts/dessert-img-default-150x150.jpg' ?>" alt="">
                            </div>
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Pequena</div>    
                                <div class="plate-description"></div>
            ...
            <div class="restaurant-category"><span>Outros Pratos</span></div>
            <div class="row c-px-1 my-2">
                <div class="col-md-6 px-1 plates">
                    <div class="col-md-12 plate-border">
                        <div class="row align-items-center">
                            <div class="col-md-3 plate-image">
                                <img src="<?php echo BASE_URL.'media/categories/others/others-plates-img-default-150x150.jpg' ?>" alt="">
                            </div>
                            <div class="col-md-9 plate-info">
                                <div class="plate-title">Pequena</div>    
                                <div class="plate-description"></div>
            ...
            <div class="container">
                <div class="feedback-list">
                    <div class="row feedback no-gutters">
                        <div class="col-md-1">
                            <div class="image">
                                <img src="<?php echo BASE_URL.'media/users/user-img-default-150x150.jpg' ?>" alt="">
                            </div>
                        </div>
                ...
                <div class="payment-online">
                    ...
                    <div class="form-group row no-gutters">
                        <span class="payment-online-methods">
                            <img src="<?php echo BASE_URL. 'media/payment-methods/card-amex-40x23.jpg' ?>" class="method-1" alt="">
                            <img src="<?php echo BASE_URL. 'media/payment-methods/card-mastercard-40x23.jpg' ?>" alt="" class="method-2">
                            <img src="<?php echo BASE_URL. 'media/payment-methods/paypal-40x23.jpg' ?>" alt="" class="method-3">
                            <img src="<?php echo BASE_URL. 'media/payment-methods/card-visa-40x23.jpg' ?>" alt="" class="method-4">
                            <img src="<?php echo BASE_URL. 'media/payment-methods/card-elo-40x23.jpg' ?>" alt="" class="method-5">
                        </span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row justify-content-between">
                            <div class="form-group row flex-column no-gutters">
                                ...
                                <span class="payment-method-1">
                                    <img src="<?php echo BASE_URL. 'media/payment-methods/money-40x23.jpg' ?>" alt="">
                                </span>
                            </div>
                            <div class="form-group row flex-column no-gutters">
                                <span class="payment-method-name mb-1">Cartão de Débito</span>
                                <span class="payment-method-2">
                                    <img src="<?php echo BASE_URL. 'media/payment-methods/card-mastercard-40x23.jpg' ?>" alt="">
                                    <img src="<?php echo BASE_URL. 'media/payment-methods/card-visa-40x23.jpg' ?>" alt="">
                                    <img src="<?php echo BASE_URL. 'media/payment-methods/card-elo-40x23.jpg' ?>" alt="">
                                </span>
                            </div>
                            <div class="form-group row flex-column no-gutters">
